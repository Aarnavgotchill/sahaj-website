...
import sahajLogo from "@/assets/sahaj trasnparent logo.png";
import studioLogo from "@/assets/Studio_Shikshaptri_white_4K.png";
import karigariLogo from "@/assets/karigari-logo-png.webp";
import sahajGallery from "@/assets/sahaj gallery placeholder.webp";
import fenilVideo from "@/assets/fenil video.mp4";
import dhrutiVideo from "@/assets/Dhruit Panchal V1.mp4";
import handsVideo from "@/assets/The Hands of Sahaj.mp4";
...
function Sahaj() {
  ...
  return (
    <main className="relative min-h-screen bg-background text-foreground">
        ...
        <div className="relative z-10 mx-auto max-w-[1200px] text-center">
          <Reveal>
            <div className="flex flex-col items-center justify-center gap-6 md:flex-row md:gap-12">
              ...
              <span className="font-display text-3xl tracking-[0.15em] text-[color:var(--gold)] md:text-4xl">
                ×
              </span>
              <div className="flex flex-col items-center gap-3">
                <img
          ...
          <Reveal delay={200}>
            ...
            <p className="mx-auto mt-6 max-w-3xl text-[clamp(1.05rem,1.2vw,1.2rem)] leading-[1.9] text-muted-foreground">
              At SAHAJ, every piece is conceived with a designer's perspective, bridging art, materiality,
              and spatial experience. Through handcrafted creations, wall art, decorative installations,
              and bespoke artistic expressions, SAHAJ transforms walls into narratives and spaces into experiences.
            </p>
          </Reveal>
            <Reveal delay={400}>
      ...
      {/* PARTNERSHIP STORY */}
      <section className="relative border-t border-border px-8 py-40 md:px-14 md:py-56">
          ...
          <div className="grid gap-16 md:grid-cols-2 md:gap-24">
            <Reveal>
              ...
              <div className="mt-10 space-y-5 text-[14px] leading-loose text-muted-foreground">
                <p>
                  SAHAJ Gallery collaborates with artists, designers, and creative studios to bring
                  distinctive art forms into architectural spaces.
                </p>
                <p>
                  <span className="font-semibold text-foreground/90">Studio Shikashapatrika – Calligraphy Series</span>
                  <br />
                  A collection that celebrates the beauty of script, language, and expression through
                  contemporary calligraphic artworks, blending tradition with modern aesthetics.
                </p>
                <p>
                  <span className="font-semibold text-foreground/90">Karigari Studio – Mosaic Series</span>
                  <br />
                  An exploration of craftsmanship and materiality through handcrafted mosaic artworks,
                  creating intricate compositions that add texture, depth, and character to interiors.
                </p>
                <p>
                  Through these collaborations, SAHAJ Gallery seeks to curate and explore innovative
                  artistic mediums and materials, combining the expertise of skilled artists with
                  thoughtful design sensibilities.
                </p>
              </div>
            </Reveal>
            <Reveal delay={200}>
              <div className="flex h-full flex-col items-center justify-center gap-10 rounded-sm border border-border bg-card/50 p-12 md:p-16">
                <div className="flex items-center justify-center gap-10">
                  ...
                  <span className="font-display text-4xl text-[color:var(--gold)] self-center">×</span>
                  <div className="flex flex-col items-center gap-3">
                    <div className="flex items-center justify-center h-28">
                      <img
                        src={karigariLogo}
      ...
      <section className="relative border-t border-border px-8 py-40 md:px-14 md:py-56">
        <div className="absolute inset-0 glow-warm opacity-50" />
          ...
          <Reveal delay={200}>
            <div className="space-y-6 text-left">
              <p className="font-sans text-[15px] leading-loose text-muted-foreground italic">
                "Some voices carry authority not because of how loudly they speak, but because of everything they have come to understand."
              </p>
              <p className="font-sans text-[17px] leading-loose text-foreground/90">
                <span className="font-bold">CA. CS. Dr. Fenil Shah (<a href="https://www.instagram.com/fenil_spark/" target="_blank" rel="noopener noreferrer" className="text-[var(--gold)] hover:underline">@fenil_spark</a>)</span>, a name that spans across domains, from finance to law, from governance to mentorship, brings with him a rare clarity of thought.
              </p>
      ...
      <section className="relative border-t border-border px-8 py-40 md:px-14 md:py-56">
        ...
        <div className="relative mx-auto grid max-w-[1400px] items-center gap-16 md:grid-cols-[1fr_1fr]">
          <Reveal delay={200}>
            <div className="space-y-6 text-left">
              <p className="font-sans text-[15px] leading-loose text-muted-foreground italic">
                "An artist's opinion on another artist's work is always a confession."
              </p>
              <p className="font-sans text-[17px] leading-loose text-foreground/90">
                <strong>Dhruti Panchal (<a href="https://www.instagram.com/dhruti_artfromheart/" target="_blank" rel="noopener noreferrer" className="text-[var(--gold)] hover:underline">@dhruti_artfromheart</a>) is one such voice in Ahmedabad's art landscape. Her appreciation of SAHAJ is meaningful not simply because it is praise, but because it is recognition one artist recognizing the sincerity, effort, and intention behind the work of fellow makers.</strong>
              </p>
              <p className="font-sans text-[15px] leading-loose text-muted-foreground">
        ...
        <div className="relative mx-auto grid max-w-[1400px] items-center gap-16 md:grid-cols-[1.5fr_1fr]">
          ...
          <Reveal delay={200}>
            <div className="space-y-6 text-left">
              ...
              <p className="font-sans text-[15px] leading-loose text-muted-foreground">
                Nehal Rathod  ·  Chintu Bhalani  ·  Hetakshi Chauhan  ·  Hansni Sharma  ·  Arya Jadav  ·  Pooja Bhavsar
              </p>
            </div>
          </Reveal>
        </div>
            ...
            <Reveal className="flex items-center md:pt-8">
              <div className="space-y-8 text-[14px] leading-loose text-foreground/80">
                ...
                <div>
                  ...
                  <p>
                    <a href="tel:+919510788933" className="hover:text-[color:var(--gold)] transition-colors">+91 95107 88933</a>
                    <br />
                    <a href="mailto:info@sahajgallery.in" className="hover:text-[color:var(--gold)] transition-colors">info@sahajgallery.in</a>
                  </p>
                  <a
                  ...
                  >
                    ...
                    <span className="text-[11px] tracking-[0.2em] uppercase">Instagram</span>
                  </a>
                </div>
              </div>
            </Reveal>
